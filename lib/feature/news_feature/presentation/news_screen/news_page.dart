          ...
          child: BlocBuilder<FetchFeaturedNewsCubit, FetchFeaturedNewsState>(
            ...
            builder: (context, state) {
              if(state is FetchFeaturedNewsStateInitial){
                return const Center(child: Text('Initial', style: MyTextStyles.greyText1,));
              }
              if(state is FetchFeaturedNewsStateLoading){
                return const Center(child: Text('Loading', style: MyTextStyles.greyText1,));
              }
                ...
                return PageView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    return Padding(
                      ...
                      child: PageViewTileWidget(articleEntity: state.listArticle[index],),
                    );
                  },
                );
              }
              if(state is FetchFeaturedNewsStateEmpty){
                return const Center(child: Text('Empty', style: MyTextStyles.greyText1,));
              }
              if(state is FetchFeaturedNewsStateError){
                return Center(child: Text(state.errorText, style: MyTextStyles.greyText1,));
              }else{
                return const Center(child: Text('Unexpected Error', style: MyTextStyles.greyText1,));
              }
            },
          ),
        ),
            ...
            child: BlocBuilder<FetchLatestNewsCubit,FetchLatestNewsState>(
              ...
              builder: (BuildContext context, state) {
                ...
                if(state is FetchLatestNewsStateError){
                  return const Center(child: Text('Error', style: MyTextStyles.greyText1,));
                }
                if(state is FetchLatestNewsStateLoaded){
                  return ListView.builder(
                    ...
                    shrinkWrap: true,
                    itemBuilder: (BuildContext context, int index) {
                      return ListViewTileWidget(articleEntity: state.listArticle[index],);
                    },
                  );
                }
