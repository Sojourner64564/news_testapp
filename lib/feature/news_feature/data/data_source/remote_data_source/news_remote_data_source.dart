...
// Предоставленные ссылки на картинки не работали я их сменил
...
To continue to enjoy ForestVPN without interruptions, please upgrade to our Premium version.''',
    ...
    ArticleModel(
      ...
      publicationDate: DateTime.now().subtract(const Duration(days: 2)).toString(),
      imageUrl: 'https://img1.akspic.ru/previews/5/4/3/4/7/174345/174345-ulybka_telefon-ulybka-zhidkiy-voda-lazurnyj-500x.jpg',
      description:
    ...
    ArticleModel(
      ...
      publicationDate: DateTime.now().subtract(const Duration(days: 2, hours: 4)).toString(),
    ...
    ArticleModel(
      ...
      publicationDate: DateTime.now().subtract(const Duration(days: 3, hours: 5)).toString(),
      imageUrl: 'https://media.gettyimages.com/id/1475080427/photo/work-bench-with-tools.jpg?s=612x612&w=gi&k=20&c=xV2SRZPwuRgukw63mLj4F235btlBZJO1onk7-okSf_U=',
      description:
